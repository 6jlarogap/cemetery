...
cp -R ../../cemetry /home/django/projects
...
createdb -U postgres cemetry
cat cemetry.sql | psql -U postgres cemetry
#Database dumps directory
mkdir /var/dumps
#Database dump cron script
chmod a+x /home/django/projects/cemetry/contrib/dumpdb.py
echo "5 0 * * *   /home/django/projects/cemetry/contrib/dumpdb.py" >> /etc/crontab
#Start django daemon
