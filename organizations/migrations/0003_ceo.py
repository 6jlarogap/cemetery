...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Organization.ceo'
        db.add_column('organizations_organization', 'ceo',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['persons.Person'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Organization.ceo'
        db.delete_column('organizations_organization', 'ceo_id')
