...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('common_location', 'city', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.GeoCity'], null=True, blank=True), keep_default=False)

        # Adding field 'Location.region'
        db.add_column('common_location', 'region', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.GeoRegion'], null=True, blank=True), keep_default=False)

        # Adding field 'Location.country'
        db.add_column('common_location', 'country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.GeoCountry'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Location.city'
        db.delete_column('common_location', 'city_id')

        # Deleting field 'Location.region'
        db.delete_column('common_location', 'region_id')

        # Deleting field 'Location.country'
        db.delete_column('common_location', 'country_id')
