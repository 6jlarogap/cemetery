...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Burial.doverennost'
        db.add_column('common_burial', 'doverennost', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Doverennost'], null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Burial.doverennost'
        db.delete_column('common_burial', 'doverennost_id')
