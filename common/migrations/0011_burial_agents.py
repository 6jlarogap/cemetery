...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.responsible_agent'
        db.add_column('common_order', 'responsible_agent', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Agent'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.responsible_agent'
        db.delete_column('common_order', 'responsible_agent_id')
