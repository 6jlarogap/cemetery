...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BankAccount.ls'
        db.add_column('common_bankaccount', 'ls', self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'BankAccount.ls'
        db.delete_column('common_bankaccount', 'ls')
