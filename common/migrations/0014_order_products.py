...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'OrderProduct.name'
        db.alter_column('common_orderproduct', 'name', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'OrderProduct.name'
        db.alter_column('common_orderproduct', 'name', self.gf('django.db.models.fields.CharField')(max_length=24))
