...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Soul.birth_date_no_month'
        db.add_column('common_soul', 'birth_date_no_month', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Soul.birth_date_no_year'
        db.add_column('common_soul', 'birth_date_no_year', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Soul.birth_date_no_month'
        db.delete_column('common_soul', 'birth_date_no_month')

        # Deleting field 'Soul.birth_date_no_year'
        db.delete_column('common_soul', 'birth_date_no_year')
    ...
    models = {
        ...
        'common.soul': {
            ...
            'birth_date_no_year': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
