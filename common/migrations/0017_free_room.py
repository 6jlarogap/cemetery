...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.rooms'
        db.add_column('common_place', 'rooms', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, blank=True), keep_default=False)

        # Adding field 'Place.rooms_free'
        db.add_column('common_place', 'rooms_free', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.rooms'
        db.delete_column('common_place', 'rooms')

        # Deleting field 'Place.rooms_free'
        db.delete_column('common_place', 'rooms_free')
