...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Soul.birth_date_no_day'
        db.add_column('common_soul', 'birth_date_no_day', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Soul.birth_date_no_day'
        db.delete_column('common_soul', 'birth_date_no_day')
