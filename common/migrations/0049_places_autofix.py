...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        for b in orm.Burial.objects.all():
            place = orm.Place.objects.filter(
                cemetery=b.product.place.cemetery,
                area=b.product.place.area,
                row=b.product.place.row,
                seat=b.product.place.seat
            )[0]
            if b.product.pk != place.pk:
                b.product = place
                b.save()
