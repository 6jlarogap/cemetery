...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'UserProfile.catafalque_text'
        db.add_column('common_userprofile', 'catafalque_text', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Adding field 'UserProfile.naryad_text'
        db.add_column('common_userprofile', 'naryad_text', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'UserProfile.catafalque_text'
        db.delete_column('common_userprofile', 'catafalque_text')

        # Deleting field 'UserProfile.naryad_text'
        db.delete_column('common_userprofile', 'naryad_text')
