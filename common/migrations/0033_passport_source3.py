...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PersonID.source'
        db.add_column('common_personid', 'source', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.DocumentSource'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PersonID.source'
        db.delete_column('common_personid', 'source_id')
