...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.responsible_customer'
        db.add_column('common_order', 'responsible_customer', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='ordr_responsible_customer', null=True, to=orm['common.Soul']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Order.responsible_customer'
        db.delete_column('common_order', 'responsible_customer_id')
