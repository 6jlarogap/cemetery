...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Burial.print_info'
        db.add_column('common_burial', 'print_info', self.gf('django.db.models.fields.TextField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Burial.print_info'
        db.delete_column('common_burial', 'print_info')
    ...
    models = {
        ...
        'common.operation': {
            'Meta': {'ordering': "['op_type']", 'object_name': 'Operation'},
