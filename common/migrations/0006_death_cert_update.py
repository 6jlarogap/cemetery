...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DeathCertificate.series'
        db.add_column('common_deathcertificate', 'series', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)

        # Adding field 'DeathCertificate.release_date'
        db.add_column('common_deathcertificate', 'release_date', self.gf('django.db.models.fields.DateField')(null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DeathCertificate.series'
        db.delete_column('common_deathcertificate', 'series')

        # Deleting field 'DeathCertificate.release_date'
        db.delete_column('common_deathcertificate', 'release_date')
