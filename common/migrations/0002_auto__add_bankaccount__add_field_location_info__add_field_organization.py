...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('common_bankaccount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Organization'])),
            ('rs', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('ks', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('bik', self.gf('django.db.models.fields.CharField')(max_length=9, blank=True)),
            ('bankname', self.gf('django.db.models.fields.CharField')(max_length=64, blank=True)),
        ))
        db.send_create_signal('common', ['BankAccount'])

        # Adding field 'Location.info'
        db.add_column('common_location', 'info', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Organization.kpp'
        db.add_column('common_organization', 'kpp', self.gf('django.db.models.fields.CharField')(default='', max_length=9, blank=True), keep_default=False)

        # Adding field 'Organization.full_name'
        db.add_column('common_organization', 'full_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True), keep_default=False)

        # Changing field 'Organization.inn'
        db.alter_column('common_organization', 'inn', self.gf('django.db.models.fields.CharField')(max_length=12))

        # Changing field 'Organization.ogrn'
        db.alter_column('common_organization', 'ogrn', self.gf('django.db.models.fields.CharField')(max_length=13))


    def backwards(self, orm):
        
        # Deleting model 'BankAccount'
        db.delete_table('common_bankaccount')

        # Deleting field 'Location.info'
        db.delete_column('common_location', 'info')

        # Deleting field 'Organization.kpp'
        db.delete_column('common_organization', 'kpp')

        # Deleting field 'Organization.full_name'
        db.delete_column('common_organization', 'full_name')

        # Changing field 'Organization.inn'
        db.alter_column('common_organization', 'inn', self.gf('django.db.models.fields.CharField')(max_length=15))

        # Changing field 'Organization.ogrn'
        db.alter_column('common_organization', 'ogrn', self.gf('django.db.models.fields.CharField')(max_length=15))
