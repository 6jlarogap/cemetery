...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'BankAccount.ls'
        db.alter_column('common_bankaccount', 'ls', self.gf('django.db.models.fields.CharField')(max_length=11, null=True))


    def backwards(self, orm):
        
        # Changing field 'BankAccount.ls'
        db.alter_column('common_bankaccount', 'ls', self.gf('django.db.models.fields.CharField')(max_length=9, null=True))
