...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Person.registration_address'
        db.add_column('common_person', 'registration_address', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Location'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Person.registration_address'
        db.delete_column('common_person', 'registration_address_id')
    ...
    models = {
        ...
        'common.person': {
            ...
            'last_name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
            'patronymic': ('django.db.models.fields.CharField', [], {'max_length': '30', 'blank': 'True'}),
            'registration_address': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.Location']", 'null': 'True', 'blank': 'True'}),
