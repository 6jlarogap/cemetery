...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Organization.ceo_document'
        db.add_column('common_organization', 'ceo_document', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Organization.personal_account'
        db.add_column('common_organization', 'personal_account', self.gf('django.db.models.fields.CharField')(max_length=9, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organization.ceo_document'
        db.delete_column('common_organization', 'ceo_document')

        # Deleting field 'Organization.personal_account'
        db.delete_column('common_organization', 'personal_account')
    ...
    models = {
        ...
        'common.organization': {
            ...
            'personal_account': ('django.db.models.fields.CharField', [], {'max_length': '9', 'null': 'True', 'blank': 'True'}),
