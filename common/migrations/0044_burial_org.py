...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Burial.organization'
        db.add_column('common_burial', 'organization', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Organization'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Burial.organization'
        db.delete_column('common_burial', 'organization_id')
