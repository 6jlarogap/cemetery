...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('common_organization', 'zip')


    def backwards(self, orm):
        
        # Adding field 'Organization.zip'
        db.add_column('common_organization', 'zip', self.gf('django.db.models.fields.CharField')(max_length=6, null=True, blank=True), keep_default=False)
