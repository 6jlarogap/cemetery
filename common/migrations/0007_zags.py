...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ZAGS'
        db.create_table('common_zags', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('common', ['ZAGS'])

        # Adding field 'DeathCertificate.zags'
        db.add_column('common_deathcertificate', 'zags', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.ZAGS'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'ZAGS'
        db.delete_table('common_zags')

        # Deleting field 'DeathCertificate.zags'
        db.delete_column('common_deathcertificate', 'zags_id')
