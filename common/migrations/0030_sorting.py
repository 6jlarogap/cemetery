...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'OrderProduct.ordering'
        db.add_column('common_orderproduct', 'ordering', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'OrderProduct.ordering'
        db.delete_column('common_orderproduct', 'ordering')
