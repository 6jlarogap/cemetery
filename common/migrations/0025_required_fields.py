...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PersonID.when'
        db.alter_column('common_personid', 'when', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'DeathCertificate.s_number'
        db.alter_column('common_deathcertificate', 's_number', self.gf('django.db.models.fields.CharField')(max_length=30, null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'PersonID.when'
        raise RuntimeError("Cannot reverse this migration. 'PersonID.when' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'DeathCertificate.s_number'
        raise RuntimeError("Cannot reverse this migration. 'DeathCertificate.s_number' and its values cannot be restored.")
    ...
    models = {
        ...
        'common.agent': {
            'Meta': {'ordering': "['uuid']", 'object_name': 'Agent', '_ormbases': ['common.Person']},
