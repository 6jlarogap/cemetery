...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Operation.ordering'
        db.add_column('common_operation', 'ordering', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Operation.ordering'
        db.delete_column('common_operation', 'ordering')
