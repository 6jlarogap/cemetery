...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Cemetery.ordering'
        db.add_column('common_cemetery', 'ordering', self.gf('django.db.models.fields.PositiveIntegerField')(default=1, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Cemetery.ordering'
        db.delete_column('common_cemetery', 'ordering')
