...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Soul', fields ['location']
        db.delete_unique('common_soul', ['location_id'])

        # Changing field 'Soul.location'
        db.alter_column('common_soul', 'location_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.Location'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Soul.location'
        db.alter_column('common_soul', 'location_id', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['common.Location'], unique=True, null=True))

        # Adding unique constraint on 'Soul', fields ['location']
        db.create_unique('common_soul', ['location_id'])
    ...
    models = {
        ...
        'common.bankaccount': {
            ...
            'ls': ('django.db.models.fields.CharField', [], {'max_length': '9', 'null': 'True', 'blank': 'True'}),
        ...
        'common.burial': {
            ...
            'organization': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['common.Organization']", 'null': 'True', 'blank': 'True'}),
