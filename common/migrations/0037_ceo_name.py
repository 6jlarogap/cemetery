...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('common_organization', 'ceo_name', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)

        # Adding field 'Organization.ceo_name_who'
        db.add_column('common_organization', 'ceo_name_who', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Organization.ceo_name'
        db.delete_column('common_organization', 'ceo_name')

        # Deleting field 'Organization.ceo_name_who'
        db.delete_column('common_organization', 'ceo_name_who')
