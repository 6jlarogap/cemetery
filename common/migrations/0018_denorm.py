...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Place.area_str1'
        db.add_column('common_place', 'area_str1', self.gf('django.db.models.fields.CharField')(max_length=9, null=True), keep_default=False)

        # Adding field 'Place.area_num'
        db.add_column('common_place', 'area_num', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'Place.area_str2'
        db.add_column('common_place', 'area_str2', self.gf('django.db.models.fields.CharField')(max_length=9, null=True), keep_default=False)

        # Adding field 'Place.row_str1'
        db.add_column('common_place', 'row_str1', self.gf('django.db.models.fields.CharField')(max_length=9, null=True), keep_default=False)

        # Adding field 'Place.row_num'
        db.add_column('common_place', 'row_num', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'Place.row_str2'
        db.add_column('common_place', 'row_str2', self.gf('django.db.models.fields.CharField')(max_length=9, null=True), keep_default=False)

        # Adding field 'Place.seat_str1'
        db.add_column('common_place', 'seat_str1', self.gf('django.db.models.fields.CharField')(max_length=9, null=True), keep_default=False)

        # Adding field 'Place.seat_num'
        db.add_column('common_place', 'seat_num', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'Place.seat_str2'
        db.add_column('common_place', 'seat_str2', self.gf('django.db.models.fields.CharField')(max_length=9, null=True), keep_default=False)

        # Adding field 'Burial.acct_num_str1'
        db.add_column('common_burial', 'acct_num_str1', self.gf('django.db.models.fields.CharField')(max_length=16, null=True), keep_default=False)

        # Adding field 'Burial.acct_num_num'
        db.add_column('common_burial', 'acct_num_num', self.gf('django.db.models.fields.PositiveIntegerField')(null=True), keep_default=False)

        # Adding field 'Burial.acct_num_str2'
        db.add_column('common_burial', 'acct_num_str2', self.gf('django.db.models.fields.CharField')(max_length=16, null=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Place.area_str1'
        db.delete_column('common_place', 'area_str1')

        # Deleting field 'Place.area_num'
        db.delete_column('common_place', 'area_num')

        # Deleting field 'Place.area_str2'
        db.delete_column('common_place', 'area_str2')

        # Deleting field 'Place.row_str1'
        db.delete_column('common_place', 'row_str1')

        # Deleting field 'Place.row_num'
        db.delete_column('common_place', 'row_num')

        # Deleting field 'Place.row_str2'
        db.delete_column('common_place', 'row_str2')

        # Deleting field 'Place.seat_str1'
        db.delete_column('common_place', 'seat_str1')

        # Deleting field 'Place.seat_num'
        db.delete_column('common_place', 'seat_num')

        # Deleting field 'Place.seat_str2'
        db.delete_column('common_place', 'seat_str2')

        # Deleting field 'Burial.acct_num_str1'
        db.delete_column('common_burial', 'acct_num_str1')

        # Deleting field 'Burial.acct_num_num'
        db.delete_column('common_burial', 'acct_num_num')

        # Deleting field 'Burial.acct_num_str2'
        db.delete_column('common_burial', 'acct_num_str2')
