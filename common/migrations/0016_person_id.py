...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('common_personid', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['common.Person'], unique=True)),
            ('id_type', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.IDDocumentType'])),
            ...
            ('who', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True)),
            ('when', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('common', ['PersonID'])

        # Adding model 'IDDocumentType'
        db.create_table('common_iddocumenttype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
        ))
        db.send_create_signal('common', ['IDDocumentType'])


    def backwards(self, orm):
        
        # Deleting model 'PersonID'
        db.delete_table('common_personid')

        # Deleting model 'IDDocumentType'
        db.delete_table('common_iddocumenttype')
