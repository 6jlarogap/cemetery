...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Agent.uuid'
        db.add_column('common_agent', 'uuid', self.gf('django.db.models.fields.CharField')(default=None, max_length=36, primary_key=True), keep_default=False)

        # Adding field 'Agent.person'
        db.add_column('common_agent', 'person', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='is_agent_of', to=orm['common.Person']), keep_default=False)

        # Deleting field 'Agent.person_ptr'
        db.delete_column('common_agent', 'person_ptr_id')
