...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'PersonID.who'
        db.delete_column('common_personid', 'who')


    def backwards(self, orm):
        
        # Adding field 'PersonID.who'
        db.add_column('common_personid', 'who', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True), keep_default=False)
