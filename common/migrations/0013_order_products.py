...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'OrderPosition'
        db.create_table('common_orderposition', (
            ...
            ('order_product', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['common.OrderProduct'])),
            ('count', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
            ('price', self.gf('django.db.models.fields.DecimalField')(max_digits=10, decimal_places=2)),
        ))
        db.send_create_signal('common', ['OrderPosition'])

        # Adding model 'OrderProduct'
        db.create_table('common_orderproduct', (
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
        ...
        db.send_create_signal('common', ['OrderProduct'])

        # Adding field 'Order.payment_type'
        db.add_column('common_order', 'payment_type', self.gf('django.db.models.fields.CharField')(default='nal', max_length=16), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'OrderPosition'
        db.delete_table('common_orderposition')

        # Deleting model 'OrderProduct'
        db.delete_table('common_orderproduct')

        # Deleting field 'Order.payment_type'
        db.delete_column('common_order', 'payment_type')
    ...
    models = {
        ...
        'common.order': {
            ...
            'payment_type': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
