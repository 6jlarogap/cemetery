...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Agent'
        db.create_table('common_agent', (
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=36, primary_key=True)),
            ('person', self.gf('django.db.models.fields.related.ForeignKey')(related_name='is_agent_of', to=orm['common.Person'])),
            ('organization', self.gf('django.db.models.fields.related.ForeignKey')(related_name='agents', to=orm['common.Organization'])),
            ('dover_number', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('dover_date', self.gf('django.db.models.fields.DateField')()),
            ('dover_expire', self.gf('django.db.models.fields.DateField')()),
        ))
        db.send_create_signal('common', ['Agent'])


    def backwards(self, orm):
        
        # Deleting model 'Agent'
        db.delete_table('common_agent')
    ...
    models = {
        ...
        'common.agent': {
            ...
            'dover_date': ('django.db.models.fields.DateField', [], {}),
            'dover_expire': ('django.db.models.fields.DateField', [], {}),
            'dover_number': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
