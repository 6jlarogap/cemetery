...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Place.unowned'
        db.add_column('cemetery_app_place', 'unowned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Burial.unowned'
        db.delete_column('cemetery_app_burial', 'unowned')


    def backwards(self, orm):
        # Deleting field 'Place.unowned'
        db.delete_column('cemetery_app_place', 'unowned')

        # Adding field 'Burial.unowned'
        db.add_column('cemetery_app_burial', 'unowned',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
