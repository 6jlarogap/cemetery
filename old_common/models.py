...
class DeathCertificate(models.Model):
    ...
    class Meta:
        ...
        db_table = 'common_deathcertificate'
...
class ProductComments(models.Model):
    ...
    class Meta:
        ...
        db_table = 'common_productcomments'
...
class UserProfile(models.Model):
    ...
    """
    user = models.OneToOneField(User, primary_key=True, editable=False, related_name='old_profile')
...
class SoulProducttypeOperation(models.Model):
    ...
    class Meta:
        ...
        db_table = 'common_soulproducttypeoperation'
